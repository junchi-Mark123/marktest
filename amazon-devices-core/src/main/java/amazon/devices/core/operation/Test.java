 ...
 *
 */
@Operation(id = AddPermissionForCompanyOperation.ID, category = Constants.CAT_DOCUMENT, label = "AMZD.AddPermissionForCompanyOperation", description = "Add permission for company doc typeThis is abstract mark")
