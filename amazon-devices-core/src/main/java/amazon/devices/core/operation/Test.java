 ...
 *
 */
@Operation(id = AddPermissionForCompanyOperation.ID, category = Constants.CAT_DOCUMENT, label = "AMZD.AddPermissionForCompanyOperation", description = "Add permission for company doc type1121212121212")
