...
public class ContentCreatedListener implements PostCommitEventListener {
    ...
    public void handleEvent(EventBundle events) {
        for (Event event : events) {
            ...
            if (Constant.DOCTYPE.PRODUCTION_CREATIVE_CONTENT.equals(type)
            		||Constant.DOCTYPE.BRAND_CREATIVE_CONTENT.equals(type)
            		||Constant.DOCTYPE.IP_CREATIVE_CONTENT.equals(type)
            		||Constant.DOCTYPE.RETAILS_CREATIVE_CONTENT.equals(type))
            		 {
